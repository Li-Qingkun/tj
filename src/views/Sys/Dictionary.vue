  ...
  <div class="page-container">
    ...
    <div class="toolbar"
      ...
      <el-form :inline="true"
               ...
               :size="size">
        <el-form-item>
          <el-input v-model="filters.label"
    ...
    <!--表格内容栏-->
    <kt-table permsEdit="sys:dictionary:update"
              permsDelete="sys:dictionary:delete"
              :data="pageResult"
              :columns="columns"
              @findPage="findPage"
    ...
    <el-dialog :title="operation?'新增':'编辑'"
      ...
      <div slot="footer"
           class="dialog-footer">
        <el-button :size="size"
                   @click.native="editDialogVisible = false">{{$t('action.cancel')}}</el-button>
        <el-button :size="size"
                   type="primary"
