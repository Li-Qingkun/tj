<template>
  <div class="page-container">
    ...
    <!--表格内容栏-->
    <kt-table permsEdit="ep:pollutant:update"
              permsDelete="ep:pollutant:delete"
              :data="pageResult"
              :columns="columns"
              @findPage="findPage"
      ...
      <el-form style="text-align:left"
        ...
        <el-form-item label="显示顺序"
          ...
          <el-input type="number"
                    ...
                    v-model="dataForm.showOrder"
                    auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="是否折算"
                      prop="cvt">
          <el-radio v-model="dataForm.cvt"
                    label="1">是</el-radio>
          <el-radio v-model="dataForm.cvt"
                    label="0">否</el-radio>
        </el-form-item>
  ...
  data() {
    return {
      ...
      dataFormRules: {
        ...
        cvt: [{ required: true, message: '请选择是否折算', trigger: 'change' }],
      },
      cvt: [],
      // 新增编辑界面数据
      dataForm: {},
