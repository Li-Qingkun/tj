<template>
  <div class="page-container">
    ...
    <kt-table permsDetails="ep:platformAddress:view"
              permsEdit="ep:company:update"
              permsDelete="ep:company:delete"
              :data="pageResult"
              :columns="columns"
              @findPage="findPage"
    ...
    <el-dialog :title="operation?'新增':'编辑'"
      ...
      <el-form :model="dataForm"
        ...
        <el-form-item label="统一社会信用代码"
                      prop="creditCode">
          <el-input v-model="dataForm.creditCode"
                    auto-complete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item label="法人手机号"
          ...
          <el-input v-model="dataForm.legalPersonMobile"
                    auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="环保负责人"
                      prop="epPerson">
          <el-input v-model="dataForm.epPerson"
                    auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="环保负责人手机号"
                      prop="epPersonMobile">
          <el-input v-model="dataForm.epPersonMobile"
                    auto-complete="off"></el-input>
        </el-form-item>
