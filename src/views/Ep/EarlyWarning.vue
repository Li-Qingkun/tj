  ...
  <div class="page-container">
	...
	<div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
		<el-form :inline="true" :model="filters" :size="size">
			...
			<el-form-item>
				<kt-button icon="fa fa-search" label="查询" perms="ep:earlyWarning:view" type="primary" @click="findPage(null)"/>
			</el-form-item>
			<el-form-item>
				<kt-button icon="fa fa-plus" label="新增" perms="ep:earlyWarning:insert" type="primary" @click="handleAdd" />
			</el-form-item>
		</el-form>
	</div>
	<!--表格内容栏-->
	<kt-table permsEdit="ep:earlyWarning:update" :data="pageResult" :columns="columns" 
	...
	<el-dialog :title="operation?'新增':'编辑'" width="40%" :visible.sync="dialogVisible" :close-on-click-modal="false">
		<el-form :model="dataForm" label-width="80px" :rules="dataFormRules" ref="dataForm" :size="size">
			...
			<el-form-item label="预警级别" prop="color">
				<el-select v-model="dataForm.color" placeholder="请选择" style="width: 100%;">
					<el-option v-for="item in colors" :key="item.value" :label="item.label" :value="item.value"></el-option>
				</el-select>
			</el-form-item>
			<el-form-item label="应急预案" prop="level">
			...
			<el-form-item label="开始时间" prop="beginTime">
				<el-date-picker v-model="dataForm.beginTime" type="datetime" placeholder="开始时间" style="width: 100%;"></el-date-picker>
			</el-form-item>
			<el-form-item label="结束时间" prop="endTime">
				<el-date-picker v-model="dataForm.endTime" type="datetime" placeholder="结束时间" style="width: 100%;"></el-date-picker>
			</el-form-item>
		</el-form>
...
export default {
	...
	data() {
		return {
			...
			columns: [
				{prop:"district", label:"行政区划", minWidth:50, formatter:this.districtFormatter},
				{prop:"color", label:"预警级别", minWidth:50,},
				{prop:"level", label:"应急预案", minWidth:50},
				{prop:"content", label:"内容", minWidth:100},
				{prop:"beginTime", label:"启动时间", minWidth:100, formatter:this.dateFormatter},
				{prop:"endTime", label:"结束时间", minWidth:100, formatter:this.dateFormatter},
			],
	...
	methods: {
		...
		findPage: function (data) {
			...
			this.$api.earlyWarning.page(this.pageRequest).then((res) => {
...
      	},
		// 获取预警级别
		listColor: function () {
			this.$api.dictionary.listByType({'type':'重污染天气预警级别'}).then((res) => {
		...
		// 获取预警级别
		listLevel: function () {
			this.$api.dictionary.listByType({'type':'重污染天气应急预案'}).then((res) => {
