  ...
  <div class="page-container">
	...
	<div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
		<el-form :inline="true" :model="filters" :size="size">
			<el-form-item>
				<el-autocomplete v-model="filters.companyId" :fetch-suggestions="queryCompanyAsync" placeholder="请选择企业名称" 
				@select="handleCompanySelectQuery" style="width: 250px;"></el-autocomplete>
			</el-form-item>
			<el-form-item>
				<kt-button icon="fa fa-search" label="查询" perms="ep:companyUser:view" type="primary" @click="findPage(null)"/>
			</el-form-item>
			<el-form-item>
				<kt-button icon="fa fa-plus" label="新增" perms="ep:companyUser:insert" type="primary" @click="handleAdd" />
			</el-form-item>
		</el-form>
	</div>
	<!--表格内容栏-->
	<kt-table permsEdit="ep:companyUser:update" permsDelete="ep:companyUser:delete"
	...
	<el-dialog :title="operation?'新增':'编辑'" width="40%" :visible.sync="dialogVisible" :close-on-click-modal="false">
		<el-form :model="dataForm" label-width="110px" :rules="dataFormRules" ref="dataForm" :size="size">
			...
			<el-form-item label="支付方式" prop="payType">
				<el-select v-model="dataForm.payType" placeholder="请选择" style="width: 100%;">
					<el-option v-for="item in payTypesLess" :key="item.value" :label="item.label" :value="item.value"></el-option>
				</el-select>
			</el-form-item>
			...
			<el-form-item label="支付时间" prop="payTime">
				<el-date-picker v-model="dataForm.payTime" type="datetime" placeholder="支付时间" style="width: 100%;"></el-date-picker>
			</el-form-item>
		</el-form>
...
export default {
	...
	data() {
		return {
			...
			columns: [
				...
				{prop:"payType", label:"支付方式", minWidth:80, formatter:this.payTypeFormatter},
				{prop:"totalAmount", label:"支付金额", minWidth:80},
				{prop:"payTime", label:"支付时间", minWidth:100, formatter:this.timeFormatter},
	...
	methods: {
		...
		findPage: function (data) {
			...
			this.$api.companyPay.page(this.pageRequest).then((res) => {
				this.pageResult = res.data
			}).then(data!=null?data.callback:'')
		},
		// 删除
		handleDelete: function (data) {
			this.$api.companyPay.deleteById(data.ids).then(data!=null?data.callback:'')
		},
		// 显示新增界面
		handleAdd: function () {
