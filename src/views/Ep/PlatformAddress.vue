  ...
  <div class="page-container">
	...
	<div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
		<el-form :inline="true" :model="filters" :size="size">
			...
			<el-form-item>
				<kt-button icon="fa fa-search" label="查询" perms="ep:platformAddress:view" type="primary" @click="findPage(null)"/>
			</el-form-item>
			<el-form-item>
				<kt-button icon="fa fa-plus" label="新增" perms="ep:platformAddress:insert" type="primary" @click="handleAdd" />
			</el-form-item>
		</el-form>
	</div>
	<!--表格内容栏-->
	<kt-table permsDetails="ep:platformAddress:view" permsEdit="ep:platformAddress:update" permsDelete="ep:platformAddress:delete"
	...
	<el-dialog :title="operation?'新增':'编辑'" width="40%" :visible.sync="dialogVisible" :close-on-click-modal="false">
		<el-form :model="dataForm" label-width="80px" :rules="dataFormRules" ref="dataForm" :size="size">
			...
			<el-form-item label="端口" prop="port">
				<el-input v-model="dataForm.port" auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="URL" prop="url">
				<el-input v-model="dataForm.url" auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="参数" prop="param">
				<el-input v-model="dataForm.param" type="textarea" auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="请求方法" prop="method">
				<el-select v-model="dataForm.method" placeholder="请选择" style="width: 100%;">
...
export default {
	...
	data() {
		return {
			...
			columns: [
				...
				{prop:"type", label:"请求类型", minWidth:50, formatter:this.typeFormatter},
				...
				{prop:"method", label:"请求方法", minWidth:50, formatter:this.methodFormatter},
	...
	methods: {
		...
		findPage: function (data) {
			...
			this.$api.platformAddress.page(this.pageRequest).then((res) => {
				this.pageResult = res.data
			}).then(data != null ? data.callback : '')
		},
		// 删除
		handleDelete: function (data) {
			this.$api.platformAddress.deleteById(data.ids).then(data != null ? data.callback : '')
		},
		// 显示新增界面
		handleAdd: function () {
...
      	},
		// 获取请求类型
		listType: function () {
			this.$api.dictionary.listByType({'type':'环保平台请求类型'}).then((res) => {
				this.types = res.data
				this.listMethod()
			})
		},
